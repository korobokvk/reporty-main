...
REPOSNAME=("data-generator" "reporty-auth-service" "reporty-client-server" "reporty-client-front-end")
IMAGES_FOR_DEV=("data-generator" "reporty-auth-service" "reporty-client-server")
